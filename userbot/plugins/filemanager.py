...
async def _(event):
    ...
    process = await asyncio.create_subprocess_seviral(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = "**Files in [FIREX](t.me/FirexSupport) DOWNLOADS Folder:**\\n"
...
CmdHelp("filemanager").add_command(
    "ls_local", None, "Gives the list of downloaded medias in your FIREX server."
).add_command(
    "ls_root", None, "Gives the list of all files in root directory of FIREX repo."
).add_command(
    "ls_saved",
    None,
    "Gives the list of all files in Saved directory of your FIREX server",
).add_command(

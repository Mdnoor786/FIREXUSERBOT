...
async def carbon_api(e):
    ...
    eviral = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await eviral.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await eviral.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await eviral.edit("`Uploading..`")
...
async def carbon_api(e):
    if e.fwd_from:
        return
    eviral = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await eviral.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
...
async def carbon_api(e):
    ...
    await eviral.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await eviral.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
...
async def carbon_api(e):
    ...
    await eviral.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await eviral.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await eviral.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await eviral.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await eviral.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await eviral.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await eviral.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await eviral.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await eviral.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await eviral.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your karbonrgb",
